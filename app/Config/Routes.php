...
$routes->get('pesanan/delete/(:segment)', 'pesanancontroller::deleteCart');

$routes->get('/detailpesanan', 'detailpesanancontroller::tampil');
$routes->add('detailpesanan', 'detailpesanancontroller::create');
$routes->get('/detailpesanan/edit/(:segment)', 'pesanancontroller::edit');
$routes->get('/detailpesanan/delete/(:segment)', 'pesanancontroller::delete');
